...
class Tcloud < Formula
    ...
    on_macos do
      if Hardware::CPU.arm?
        url "https://github.com/thalassa-cloud/cli/releases/download/v0.0.1/tcloud_0.0.1_darwin_arm64.tar.gz", :using => CurlDownloadStrategy
      ...
      if Hardware::CPU.intel?
        url "https://github.com/thalassa-cloud/cli/releases/download/v0.0.1/tcloud_0.0.1_darwin_amd64.tar.gz", :using => CurlDownloadStrategy
    ...
    on_linux do
      if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
        url "https://github.com/thalassa-cloud/cli/releases/download/v0.0.1/tcloud_0.0.1_linux_arm64.tar.gz", :using => CurlDownloadStrategy
      ...
      if Hardware::CPU.intel?
        url "https://github.com/thalassa-cloud/cli/releases/download/v0.0.1/tcloud_0.0.1_linux_amd64.tar.gz", :using => CurlDownloadStrategy
